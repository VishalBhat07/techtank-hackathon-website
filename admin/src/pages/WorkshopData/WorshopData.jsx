...
const WorkshopData = () => {
  ...
  const handleStatusChange = async (workshop, status) => {
    console.log(
      `Changing status for workshop registration ${workshop._id} to ${status}`
    );
              ...
              {filteredWorkshops.map((workshop) => (
                <tr key={workshop._id || workshop.transactionId}>
                  ...
                  <td className="registration-date">
                    {formatDate(
                      workshop.registrationDate || workshop.createdAt
                    )}
                  </td>
                  <td className="status-cell">
                    <span
                      className={`status-badge ${workshop.status || "pending"}`}
                    >
